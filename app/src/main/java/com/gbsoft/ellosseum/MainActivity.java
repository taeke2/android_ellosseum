...
//        getWindow().addFlags(WindowManager.LayoutParams.FLAG_SECURE);   // 캡처 화면 방지 기능
        ...
        mBinding.btnGpsStop.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (mIsService) {
                    Common.stopLocationService(getApplicationContext(), Common.isLocationServiceRunning(MainActivity.this));
                    mBinding.btnGpsStop.setText("Start");
                } else {
                    Common.startLocationService(getApplicationContext(), Common.isLocationServiceRunning(MainActivity.this));
...
//            Common.startLocationService(getApplicationContext(), Common.isLocationServiceRunning(MainActivity.this)); // GPS 서비스 실행
...
//            Common.startLocationService(getApplicationContext(), Common.isLocationServiceRunning(MainActivity.this));
     ...
     * Store the token in SharedPreferences, because it is initialized each time a new load is made.
     */
    // 토큰 갱신
    ...
    public void uniqueIdUpdate() {
        @SuppressLint("SimpleDateFormat") String currentTime = Common.getCurrentTime(new SimpleDateFormat("yyyy-MM-dd HH:mm:ss"));
        ...
        call.enqueue(new Callback<ResponseBody>() {
            ...
            public void onResponse(@NotNull Call<ResponseBody> call, @NotNull Response<ResponseBody> response) {
                ...
                if (code == 200){
                    ...
                    if (!MainActivity.this.isFinishing())
                        Common.showDialog(MainActivity.this, getString(R.string.dialog_error_title), getString(R.string.dialog_response_error_content), () -> { });
                }
            }
            ...
            public void onFailure(Call<ResponseBody> call, Throwable t) {
                if (!MainActivity.this.isFinishing())
                    Common.showDialog(MainActivity.this, getString(R.string.dialog_error_title), getString(R.string.dialog_connect_error_content), () -> { });
            }
        });
    }
            ...
            public void onResponse(@NotNull Call<ResponseBody> call, @NotNull Response<ResponseBody> response) {
                ...
                if (code == 200) {
                    try {
                        ...
                        if (!MainActivity.this.isFinishing())
                            Common.showDialog(MainActivity.this, getString(R.string.dialog_error_title), getString(R.string.dialog_catch_error_content), () -> { });
                    } catch (IOException e) {
